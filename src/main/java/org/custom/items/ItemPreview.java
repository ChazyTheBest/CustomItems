...
public class ItemPreview
{
    ...
    private static Map<Integer, String> initSpellId()
    {
        ...
        (
            ...
            Map.entry(16041, "Increases the critical strike chance of your Lightning Bolt, Chain Lightning and Thunderstorm spells by an additional $s1%."),
            ...
            Map.entry(16620, "make you invulnerable to melee damage for $16621d. This effect can only occur once every 30 sec."),
            Map.entry(18275, "Increases the damage dealt or life drained by your Shadow spells and your Felhunter's Shadow Bite ability by $s1%."),
            Map.entry(18278, "Silences an enemy preventing it from casting spells for $d."),
            Map.entry(19180, "Increases your Agility by $s1%."),
            ...
            Map.entry(21874, "Reduces the cooldown of your Vanish ability by $/1000;s1 sec."),
            ...
            Map.entry(23554, "Health or Mana gained from Drain Life and Drain Mana increased by $s1%."),
            ...
            Map.entry(30675, "Gives your Lightning Bolt and Chain Lightning spells a $h% chance to cast a second, similar spell on the same target at no additional cost that causes half damage and no threat."),
            ...
            Map.entry(31850, "Damage that takes you below 35% health is reduced by $s1%. In addition, attacks which would otherwise kill you cause you to be healed by up to $s2% of your maximum health (amount healed based on defense).  This healing effect cannot occur more often than once every $66233d."),
            ...
            Map.entry(37187, "Increases the damage dealt by your Judgements by $s1%."),
            ...
            Map.entry(38392, "Increases the damage dealt by your Steady Shot ability by $s1%."),
            Map.entry(38397, "Increases the damage of your Fireball, Frostbolt, and Arcane Missiles abilities by $s1%."),
            Map.entry(38399, "Increases the damage of your Mortal Strike and Bloodthirst abilities by $s1%."),
            ...
            Map.entry(58874, "Whenever you take damage from or block a melee attack you cause damage equal to $s1% of your block value."),
            ...
            Map.entry(60175, "Increases the duration of your Shield Wall by $/1000;s1 seconds."),
            ...
            Map.entry(63650, "Increases all healing done by you and all healing effects on you by $s1%."),
            Map.entry(64735, "Increases the critical strike chance of Death Coil and Frost Strike by $s1%."),
            Map.entry(64744, "Rune Strike deals 10% extra damage."),
            Map.entry(64854, "Serpent Sting deals 10% extra damage."),
            Map.entry(64878, "Increases the damage done by your Exorcism and Hammer of Wrath abilities by $s1%."),
            ...
            Map.entry(64928, "Your critical strikes from Lightning Bolt cause the target to take nature damage equal to $s1% of the Lightning Bolt's damage over $64930d."),
            Map.entry(64931, "Increases the damage done by your Unstable Affliction by $s1% and your Immolate by $s2%."),
            ...
            Map.entry(67185, "Increases the critical strike chance of your Fireball, Frostbolt, Frostfire Bolt, Arcane Missiles, and Arcane Blast spells by $s1%."),
            Map.entry(67187, "Decreases the cooldown on your Divine Protection ability and reduces the duration of Forbearance by ${$m1/-1000} sec."),
            ...
            Map.entry(67221, "Increases the damage done by your Earth Shock, Flame Shock, and Frost Shock spells by $s1%."),
            Map.entry(67228, "Your Lava Burst spell causes your target to burn for an additonal $67228s1% of your spell's damage over $71824d."),
            ...
            Map.entry(67273, "Decreases the cooldown on your Shield Block ability by ${$m1/-1000} sec."),
            ...
            Map.entry(70801, "Reduces the channel duration by ${$m1/-1000}.1 sec and period by ${$m1/-3000}.2 sec on your Mind Flay spell."),
            ...
            Map.entry(70871, "Empowers the caster with dark might, increasing all damage dealt by $s1% and heal the caster for $s2% of his damage dealt."),
